...
public class MyAdsRecyclerViewAdapter extends RecyclerView.Adapter<MyAdsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyAdsRecyclerViewAdapter(ArrayList<Ad> ads, OnItemClickListener l) {
        this.ads = ads;
        this.listener = l;
    }
    ...
    @NonNull
    @Override
    public MyAdsRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v;
        if (viewType == TYPE_CARGO){
    ...
    @Override
    public void onBindViewHolder(@NonNull MyAdsRecyclerViewAdapter.ViewHolder holder, int position) {
        Ad ad = ads.get(position);
        ...
        switch (getItemViewType(position)){
            case TYPE_CARGO:
                ...
                String dimensions = holder.itemView.getContext().getString(R.string.show_ad_title_dimensions);
                ...
                holder.tvDimensions.setText(dimensions + ": " + cargoDimensions);
